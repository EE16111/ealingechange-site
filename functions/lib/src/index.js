...
exports.checkRateAlerts = exports.sendOrderConfirmation = void 0;
...
exports.sendOrderConfirmation = (0, firestore_1.onDocumentCreated)("orders/{orderId}", async (event) => {
...
exports.checkRateAlerts = (0, scheduler_1.onSchedule)("every 1 hours", async (event) => {
